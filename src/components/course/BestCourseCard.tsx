    ...
    return (
        <div className="flex flex-col w-full flex-1 min-w-0">
            <Link href={`/courses/${courseId}`} className="w-full">
                {/* 썸네일 이미지 영역 */}
                <div className="relative aspect-4/5 border border-[#E1E1E1] rounded-lg overflow-hidden bg-gray-100">
                    <Image
            ...
            <div className="flex p-1 items-center justify-between">
                <div className="flex flex-col flex-1 gap-0.5 min-w-0">
                    ...
                    <span className="text-[9px] font-semibold text-[#8E8E8E] truncate">{writer}</span>
                </div>
